                        ...
                        <div class="content-header">
                            <div class="container-fluid">
                                <div class="row mb-2">
                                    <div class="col-sm-12">
                                        <div class="row-title">
                                            <h5 class="m-0">{{ __('Create Another Store') }}</h5>
                                        </div>
                                    </div><!-- /.col -->
                                </div><!-- /.row -->
                            </div><!-- /.container-fluid -->
                                ...
                                <form class="needs-validation" >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" id="address" rows="3" placeholder="Enter Store  Address"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="email">Email Address</label>
                                            <input type="text" class="form-control"  id="email" placeholder="Enter Store Email" >
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="landline">Landline</label>
                                            <input type="text" class="form-control"  id="landline" placeholder="Enter 10-Digit Landline Number" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"  id="mobileNum" placeholder="i.e 639XXXXXXXXX" >
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="storeStatus">Store Status</label>
                                            <select id="storeStatus" class="form-control">
                                                <option disabled selected value="">---------- Select Store Status ----------</option>
...
<script>
    ...
    function returnTo() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'stores'; // Redirect to the "products" page
                }
            })
        }
    ...
    function store() {
        ...
        axios.post('create_stores', formData)
